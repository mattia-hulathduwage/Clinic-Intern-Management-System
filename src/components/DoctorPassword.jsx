...
const DoctorPassword = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/doctor/validate-password", {
        method: "POST",
        headers: {
      ...
      // Update the password
      const updateResponse = await fetch("http://localhost:5000/api/doctor/update-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
