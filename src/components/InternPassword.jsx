...
const InternPassword = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/intern/validate-password", {
        method: "POST",
        headers: {
      ...
      // Update the password
      const updateResponse = await fetch("http://localhost:5000/api/intern/update-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
