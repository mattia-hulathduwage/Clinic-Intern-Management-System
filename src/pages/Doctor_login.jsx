...
const Doctor_Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("doctor_fname", response.data.doctor_fname);
      localStorage.setItem("doctor_lname", response.data.doctor_lname);
      localStorage.setItem("doctor_username", username);
      localStorage.setItem("doctor_password", password);
      
      
      navigate("/doctor-dashboard"); // Adjust the path as needed
    } catch (err) {
      ...
      <div style={styles.rightPane}>
        <div style={styles.content}>
          <div style={styles.formContainer}>
            <h1 style={styles.heading}>Log in to your Doctor Account</h1>
