...
import { FaUpload, FaSearch, FaUser, FaArrowRight } from "react-icons/fa";
import SidebarAdmin from "../components/SidebarIntern";
    ...
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        <div style={styles.header}>
          <h1 style={styles.title}>Patients overview</h1>
                ...
                >
                  ...
                  <td style={styles.tableCell}>
                    <button
                      ...
                      onClick={() =>
                        navigate(`/intern/patientprofile/${patient.id}`)
                      }
                      onMouseEnter={(e) =>
