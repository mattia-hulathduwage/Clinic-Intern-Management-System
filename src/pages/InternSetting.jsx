...
import InternPassword from "../components/InternPassword";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faLock } from "@fortawesome/free-solid-svg-icons";

const InternSetting = () => {
  const [traineeUsername, setTraineeUsername] = useState("");
  const [traineeFullName, setTraineeFullName] = useState("");
  const [traineePassword, setTraineePassword] = useState("");
  const [isPopupVisible, setIsPopupVisible] = useState(false);

  useEffect(() => {
    const traineeFName = localStorage.getItem("trainee_fname");
    const traineeLName = localStorage.getItem("trainee_lname");
    const username = localStorage.getItem("trainee_username");
    const password = localStorage.getItem("trainee_password");

    if (traineeFName && traineeLName) {
        setTraineeFullName(`  ${traineeFName} ${traineeLName}`);
    }
    if (username) {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        <p style={styles.adminName}>{traineeFullName}</p>
        <p style={styles.adminTitle}>Trainee</p>
        ...
        {isPopupVisible && (
          <InternPassword onClose={() => setIsPopupVisible(false)} />
        )}
